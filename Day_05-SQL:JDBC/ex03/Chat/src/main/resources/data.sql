INSERT INTO chat.Users ( login, password, createdrooms, rooms )
...
INSERT INTO chat.Chatroom (roomName, ownerID)
VALUES ('general', 1),
       ('random', 2),
       ('born-to-code', 3),
       ('random', 4),
...
INSERT INTO chat.Message (userID, roomID, textMessage, dateMessage)
